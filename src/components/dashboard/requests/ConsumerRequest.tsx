...
import { Search2, Empty, PaginationNext, PaginationPrev, NoImage, CloseDraw } from '../../../assets'
...
const ConsumerRequest = (props: any) => {
    ...
    const [payment_method, setPaymentMethod] = React.useState('' as any)
    const [formError, setFormError] = React.useState(false)

    const { role, merchant_type, email } = useAppSelector((state) => state.auth)
    ...
    const handlePayWithWallet = (amount: any) => {
        props.payForServiceRequest({
            amount: amount,
                                            ...
                                            <td className=" border-b border-gray5 align-middle font-light text-sm whitespace-nowrap px-2 py-4 text-left">
                                                ...
                                                <div className="absolute right-12 mt-2 py-2 w-48 bg-white rounded-md shadow-2xl z-[999]" style={{
                                                    ...
                                                    <ul>
                                                        ...
                                                        {isRole === 'consumer' && request.requestStatus === 'Accepted' && (
                                                            <div>
                                                                {props.loading && payment_method === 'wallet' ? (
                                                                    <li>
                                                                        <div className="px-4 py-2 text-sm text-gray11 font-medium hover:bg-primary6 hover:text-white flex items-center gap-1">
                                                                            <svg className="animate-spin h-5 w-5 mr-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                                                                <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle>
                                                                    ...
                                                                    <li>
                                                                        <div className="block px-4 py-2 text-sm text-gray11 font-medium hover:bg-primary6 hover:text-white cursor-pointer"
                                                                            onClick={() => {
                                                                                ...
                                                                                handlePayWithWallet(request.service.service.pricing)
                                                                            }}
                                                                        >
                                                                            Pay with wallet
                                                                        </div>
                                                                ...
                                                                {props.loading && payment_method === 'paystack' ? (
                                                                    <li>
                                                                        <div className="px-4 py-2 text-sm text-gray11 font-medium hover:bg-primary6 hover:text-white flex items-center gap-1">
                                                                            <svg className="animate-spin h-5 w-5 mr-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                                                                <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle>
                                                                    ...
                                                                    <li>
                                                                        <div className="block px-4 py-2 text-sm text-gray11 font-medium hover:bg-primary6 hover:text-white cursor-pointer"
                                                                            onClick={() => {
                                                                                ...
                                                                                toggleDrawer()
                                                                                setAmount(request.service.service.pricing)
                                                                            }}
                                                                        >
                                                                            Pay with paystack
                                                                        </div>
                                                        ...
                                                        {request.paymentStatus === 'Completed' && request.requestStatus !== 'Completed' && (
                                                            <div>
                                                                {props.loading ? (
                                                                    <li>
                                                                        <div className="px-4 py-2 text-sm text-gray11 font-medium hover:bg-primary6 hover:text-white flex items-center gap-1">

...
const SearchProduct = (props: any) => {
    ...
    const [filteredItems, setFilteredItems] = useState(props.filteredProducts || []);
    ...
    React.useEffect(() => {
        if (props.query.minPrice || props.query.maxPrice || props.query.discount || props.query.rating) {
            const filterProduct = (minPrice: string, maxPrice: string, rating: string, discountPercentage: string) => {
                const filteredItems = props.filteredProducts.filter((item: any) => {
            ...
            setFilteredItems(props.filteredProducts)
        }
    }, [props.query.minPrice, props.query.maxPrice, props.query.discount, props.query.rating, props.filteredProducts])
